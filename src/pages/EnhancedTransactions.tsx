...
const EnhancedTransactions = () => {
  ...
  const handleTransactionCreate = () => {
    ...
    toast({
      title: "Success",
      description: "Transaction created successfully with integrated services",
    });
  };
  ...
  return (
    <div className="p-8">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-lg font-brand-body text-brand-charcoal/70 max-w-2xl">
              Manage all your real estate transactions with integrated service tiers and vendor preferences
            </p>
          </div>
          <Button 
      ...
      {/* Enhanced Create Transaction Dialog with Service Tier Selection */}
      <EnhancedCreateTransactionDialog

...
import { MilestoneCalculationInput, TransactionMilestone } from '@/types/dashboard';
...
const UpcomingDeadlinesPane = () => {
  ...
  const getMilestones = (transaction: MilestoneCalculationInput): TransactionMilestone[] => {
      ...
      milestones.push(
        {
          ...
          date: earnestMoneyDue.toISOString().split('T')[0],
          priority: 'high',
        },
        {
          type: 'Inspection Period',
          date: inspectionPeriod.toISOString().split('T')[0],
          priority: 'medium',
        },
        {
          type: 'Appraisal Due',
          date: appraisalDue.toISOString().split('T')[0],
          priority: 'medium',
        },

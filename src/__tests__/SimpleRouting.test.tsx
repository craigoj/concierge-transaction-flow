  ...
  return (
    <MemoryRouter initialEntries={[initialRoute]}>
      <Routes>
        ...
        <Route path="/agent/transactions/:id" element={<TestComponent pageName="Agent Transaction Detail" />} />
...
describe('Simple Page Routing Tests', () => {
  ...
  describe('404 Error Handling', () => {
    ...
    it('renders 404 for invalid nested routes', () => {
      ...
      expect(screen.getByTestId('page-name')).toHaveTextContent('404 Not Found')
      expect(screen.getByTestId('current-path')).toHaveTextContent('/transactions/invalid/nested/route')
    })
  ...
  describe('Route Precedence', () => {
    ...
    it('handles agent routes vs regular routes', () => {
      ...
      expect(screen.getByTestId('page-name')).toHaveTextContent('Agent Dashboard')
      expect(screen.getByTestId('page-name')).not.toHaveTextContent('Dashboard')
    })
  })
})
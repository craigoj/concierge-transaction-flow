  ...
  return (
    <MemoryRouter initialEntries={[initialRoute]}>
      <div>
        ...
        {redirectTo && <div data-testid="redirect-to">{redirectTo}</div>}
      </div>
    </MemoryRouter>
  );
};
...
describe('Role-Based Routing', () => {
  ...
  describe('Agent Role Routing', () => {
    it('allows agent to access agent dashboard', () => {
      renderWithProviders(<RoleBasedRoutingApp userRole="agent" initialRoute="/agent/dashboard" />);
    ...
    it('allows agent to access agent setup page', () => {
      renderWithProviders(<RoleBasedRoutingApp userRole="agent" initialRoute="/agent/setup" />);
    ...
    it('redirects agent from coordinator routes to agent dashboard', () => {
      renderWithProviders(<RoleBasedRoutingApp userRole="agent" initialRoute="/dashboard" />);
    ...
    it('redirects agent from transactions page to agent dashboard', () => {
      renderWithProviders(<RoleBasedRoutingApp userRole="agent" initialRoute="/transactions" />);

      expect(screen.getByTestId('redirect-to')).toHaveTextContent('/agent/dashboard');
    });

    it('redirects agent from clients page to agent dashboard', () => {
      renderWithProviders(<RoleBasedRoutingApp userRole="agent" initialRoute="/clients" />);

      expect(screen.getByTestId('redirect-to')).toHaveTextContent('/agent/dashboard');
    });

    it('redirects agent from settings page to agent dashboard', () => {
      renderWithProviders(<RoleBasedRoutingApp userRole="agent" initialRoute="/settings" />);
  ...
  describe('Coordinator Role Routing', () => {
    it('allows coordinator to access coordinator dashboard', () => {
      renderWithProviders(<RoleBasedRoutingApp userRole="coordinator" initialRoute="/dashboard" />);
    ...
    it('allows coordinator to access transactions page', () => {
      renderWithProviders(
        <RoleBasedRoutingApp userRole="coordinator" initialRoute="/transactions" />
      );
    ...
    it('allows coordinator to access clients page', () => {
      renderWithProviders(<RoleBasedRoutingApp userRole="coordinator" initialRoute="/clients" />);
    ...
    it('allows coordinator to access settings page', () => {
      renderWithProviders(<RoleBasedRoutingApp userRole="coordinator" initialRoute="/settings" />);
    ...
    it('redirects coordinator from agent routes to coordinator dashboard', () => {
      renderWithProviders(
        <RoleBasedRoutingApp userRole="coordinator" initialRoute="/agent/dashboard" />
      );
    ...
    it('redirects coordinator from agent setup to coordinator dashboard', () => {
      renderWithProviders(
        <RoleBasedRoutingApp userRole="coordinator" initialRoute="/agent/setup" />
      );
  ...
  describe('Role-Based Access Control', () => {
    it('applies different access rules for different roles', () => {
      ...
      const { rerender } = renderWithProviders(
        <RoleBasedRoutingApp userRole="agent" initialRoute="/transactions" />
      );
  ...
  describe('Unauthenticated Access', () => {
    it('handles null role appropriately', () => {
      renderWithProviders(<RoleBasedRoutingApp userRole={null} initialRoute="/dashboard" />);
